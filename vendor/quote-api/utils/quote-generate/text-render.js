...
function renderText (layout, prepared, fontColor) {
  ...
  // Hararest: native canvas allocations are not covered by a worker's JS heap limit.
  if (canvasWidth > 4096 || canvasHeight > 4096 || canvasWidth * canvasHeight > 8000000) {
    throw new Error('Quote text exceeds the native canvas budget')
  }
